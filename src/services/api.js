...
// 🛑 Direct Hardcoded Render Production URL to bypass any Vercel environment variable issues
const API_BASE_URL = 'https://interactive-recipe-sharing-platform.onrender.com/api';
