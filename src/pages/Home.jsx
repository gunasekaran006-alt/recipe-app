...
function Home() {
    ...
    useEffect(() => {
        getRecipes().then(data => {
            if (data && Array.isArray(data)) {
                setRecipes(data); // 🛠️ Removed .reverse() here so sorting works correctly!
    ...
    // 🆕 1. New Arrivals: createdAt (Latest first)
    const newArrivals = [...recipes]
        .sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt))
        .slice(0, 3);

    // 🆕 2. Trending Recipes: Reviews  /  Rating 
